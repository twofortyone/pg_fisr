...
path = '/models/IEEE_123_FLISR_Case/Master.DSS'  # IEEE 123 Node Test Feeder
...
voltages = pd.read_feather('/data/123_06022020_nsimulation/ieee123bus_voltages_2020-06-02.ftr').to_numpy()
iso_loads = pd.read_feather('/data/123_06022020_nsimulation/ieee123bus_isolated_loads_2020-06-02.ftr').to_numpy()
num_loops = pd.read_feather('/data/123_06022020_nsimulation/ieee123bus_num_loops_2020-06-02.ftr').to_numpy()
...
term_states = pd.read_feather('/data/123_06022020_nsimulation/ieee123bus_terminal_states_2020-06-02.ftr').to_numpy()
